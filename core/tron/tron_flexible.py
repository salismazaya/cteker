...
class TronNileTestnetTokenFlexible(TronNileTestnetClientMixin, TronTokenCore):
...
class TronMainnetTokenFlexible(TronMainnetClientMixin, TronNileTestnetTokenFlexible):
    pass
